...
Six months into the discipline, I found I could answer questions I couldn't have answered without it: *what percentage of our bug-fix commits involved AI authorship? Which subsystems had the most AI influence? Were AI-authored changes more or less likely to be reverted?* All of this became queryable because every AI contribution had a label. None of it would have been queryable if we'd let the AI sign commits with the human's name alone.
